...
func init() {
	...
	db, err = sql.Open("mysql", "root:garden100@tcp(127.0.0.1:3306)/hosting.db")
...
func home(w http.ResponseWriter, r *http.Request) {
	...
	// fmt.Fprintf(w, `my name is MD. HAZRAT ALI`)
}
...
func request(w http.ResponseWriter, r *http.Request) {
	...
	//fmt.Fprintf(w, `peyechi %s %s %s`, name, company, email) //response
